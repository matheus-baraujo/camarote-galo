...
// Recebe o parâmetro CPF da URL (ex: ?cpf=12345678900)
$cpf = $_GET['cpf'] ?? '';
...
$stmt = $conn->prepare("SELECT * FROM compras_saojoao2025 WHERE cpfCliente = ?");
...
if (!empty($compras)) {
    ...
    echo json_encode(['error' => 'Nenhuma compra encontrada para este CPF']);
}
